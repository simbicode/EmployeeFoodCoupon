...
tk.Label(displayResult, text="--------------------", anchor = 'w',font=(fontOfLabel, sizeOfLabel)).grid(row = 0, column=3)
...
tk.Label(displayResult, text="--------------------", anchor = 'w', font=(fontOfLabel, sizeOfLabel)).grid(row = 2, column=3)
...
tk.Label(displayResult, text="--------------------", font=(fontOfLabel, sizeOfLabel), anchor = 'w').grid(row = 4, column=3)
...
tk.Label(displayResult, text="--------------------", font=(fontOfLabel, sizeOfLabel), anchor = 'w').grid(row = 6 , column=3)
